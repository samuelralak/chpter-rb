require_relative 'lib/chpter/rb/version'

Gem::Specification.new do |spec|
  spec.name          = "chpter-rb"
  spec.version       = Chpter::Rb::VERSION
  spec.authors       = ["Samuel Ralak"]
  spec.email         = ["thesamuelralak@gmail.com"]

  spec.summary       = %q{Chpter Ruby}
  spec.description   = %q{The unofficial ruby wrapper for the Chpter REST API}
